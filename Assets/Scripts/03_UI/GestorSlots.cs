...
public class GestorSlots : MonoBehaviour
{
    ...
    public string escenaNuevaPartida = "IntroJuego"; // Nombre del cómic
    public string escenaCargarPartida = "Seleccion_Niveles";

    [Header("Slot 1")]
    public TextMeshProUGUI txtNombreS1;
    public GameObject btnJugarS1, btnBorrarS1, grupoCrearS1;
    public TMP_InputField inputS1; // El recuadro se escribe el nombre
